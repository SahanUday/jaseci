...
def test_start_with_client_does_initial_compilation() -> None:
    """Test that `jac start` with client enabled performs initial compilation."""
    import time

    test_project_name = "test-start-client"
